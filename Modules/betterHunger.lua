...
foods      = { "none", "apple", "baked_potato", "beetroot", "beetroot_soup", "bread", "carrot", "chorus_fruit",
    "cooked_chicken", "cooked_cod", "cooked_mutton", "cooked_porkchop", "cooked_rabbit", "cooked_salmon", "cookie",
    "dried_kelp", "enchanted_golden_apple", "golden_apple", "glow_berries", "golden_carrot", "honey_bottle",
    "melon_slice", "mushroom_stew", "poisonous_potato", "potato", "pufferfish", "pumpkin_pie", "rabbit_stew", "raw_beef",
    "raw_chicken", "raw_cod", "raw_mutton", "raw_porkchop", "raw_rabbit", "raw_salmon", "rotten_flesh", "spider_eye",
    "cooked_beef", "suspicious_stew", "sweet_berries", "tropical_fish" }
hunger     = { 0, 4, 5, 1, 6, 5, 3, 4, 6, 5, 6, 4, 5, 6, 2, 1, 4, 4, 2, 6, 6, 2, 6, 2, 1, 1, 8, 10, 3, 2, 2, 2, 3, 3, 2,
    4, 2, 8, 6, 2, 1 }
saturation = { 0, 2, 6, 1, 7, 6, 4, 2, 7, 6, 10, 13, 6, 10, 0, 0, 10, 10, 0, 14.4, 1, 1, 7, 1, 1, 0.2, 4.8, 12, 1.8, 1.2,
    0.4, 1.2, 1.8, 1.8, 0.4, 0.8, 3.2, 12.8, 7.2, 1.2, 0.2 }
