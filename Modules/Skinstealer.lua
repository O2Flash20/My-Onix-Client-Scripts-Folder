...
function update()
    mouseButtonToUse.visible = not shutUpBloat.value
    mouseSettingsAir.visible = not shutUpBloat.value
    mouseSettingsInfo.visible = not shutUpBloat.value
    disableMiddleClick.visible = not shutUpBloat.value
    holdToSteal.visible = not shutUpBloat.value
    disableChatMessage.visible = not shutUpBloat.value
    warningMessage.visible = not shutUpBloat.value
    disableMouseButtons.visible = not shutUpBloat.value
    chatSettingsInfo.visible = not shutUpBloat.value
    miscSettingsInfo.visible = not shutUpBloat.value
    skinStealFolderFunc.visible = not shutUpBloat.value
    lastSkinFolderFunc.visible = not shutUpBloat.value
    stealLocalSkin.visible = not shutUpBloat.value
